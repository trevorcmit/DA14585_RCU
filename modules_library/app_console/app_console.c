 ...
 * \file app_console.c
 *
 * \brief Application console related functions source file
 *
...
int arch_printf(const char *fmt, ...)
{
    ...
    if (msg) {
        ...
        // if printf_msg_list is NULL we can send the msg immediately (in the synchronous part of the loop), else 
