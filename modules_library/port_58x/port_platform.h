 ...
 * \param[in]  high
*****************************************************************************************/
#define PORT_CONFIGURE_GPIO(pin_conf, mode, function, high) GPIO_ConfigurePin((GPIO_PORT)pin_conf.port, (GPIO_PIN)pin_conf.pin, mode, function, high)
 ...
 * \param[in]  function
*****************************************************************************************/
#define PORT_SET_PIN_FUNCTION(pin_conf, mode, function) GPIO_SetPinFunction((GPIO_PORT)pin_conf.port, (GPIO_PIN)pin_conf.pin, mode, function)
