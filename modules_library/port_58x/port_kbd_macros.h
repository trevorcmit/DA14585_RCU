 ...
 */
        ...
        #define COL(x)  ( ( ((COLUMN_INPUT_##x##_PORT == UART_RX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_RX_PIN)) || \
                            ((COLUMN_INPUT_##x##_PORT == UART_TX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_TX_PIN)) ) ? \
                          (4 << 4) | (COLUMN_INPUT_##x##_PIN) : ( (COLUMN_INPUT_##x##_PORT << 4) | (COLUMN_INPUT_##x##_PIN) ) )
    #else               
        #define COL(x)  ( ( ((COLUMN_INPUT_##x##_PORT == UART_TX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_TX_PIN)) ) ? \
                          (4 << 4) | (COLUMN_INPUT_##x##_PIN) : ( (COLUMN_INPUT_##x##_PORT << 4) | (COLUMN_INPUT_##x##_PIN) ) )
    #endif              
#else                   
 ...
 */
#if defined(CFG_PRINTF) 
    #define ROW(x)      ( ( ((ROW_OUTPUT_##x##_PORT == UART_RX_PORT) && (ROW_OUTPUT_##x##_PIN == UART_RX_PIN)) || \
                            ((ROW_OUTPUT_##x##_PORT == UART_TX_PORT) && (ROW_OUTPUT_##x##_PIN == UART_TX_PIN)) ) ? \
...
#if defined(CFG_PRINTF)
    #ifndef DISABLE_UART_RX  
        #define SET_BITMAP(x)   ( ( ((ROW_OUTPUT_##x##_PORT == UART_RX_PORT) && (ROW_OUTPUT_##x##_PIN == UART_RX_PIN)) || \
                                    ((ROW_OUTPUT_##x##_PORT == UART_TX_PORT) && (ROW_OUTPUT_##x##_PIN == UART_TX_PIN)) || \
                                    (ROW_OUTPUT_##x##_PORT >= 4) ) ? (0) : ( (1 << ROW_OUTPUT_##x##_PIN) ) )
    #else
        #define SET_BITMAP(x)   ( ( ((ROW_OUTPUT_##x##_PORT == UART_TX_PORT) && (ROW_OUTPUT_##x##_PIN == UART_TX_PIN)) || \
                                    (ROW_OUTPUT_##x##_PORT >= 4) ) ? (0) : ( (1 << ROW_OUTPUT_##x##_PIN) ) )
    #endif
#else
...
#if defined(CFG_PRINTF)
    #ifndef DISABLE_UART_RX
        #define SET_INPUT_MODE_REG(x)   ( ( ((COLUMN_INPUT_##x##_PORT == UART_RX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_RX_PIN)) || \
                                            ((COLUMN_INPUT_##x##_PORT == UART_TX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_TX_PIN)) || \
                                            (COLUMN_INPUT_##x##_PORT >= 4) ) ? (0) : 
                                          ( ((P00_MODE_REG - P0_DATA_REG) + (COLUMN_INPUT_##x##_PORT == 3 ? \
                                          4 : COLUMN_INPUT_##x##_PORT) * 0x20) + (COLUMN_INPUT_##x##_PIN * 2) ) )
    #else
        #define SET_INPUT_MODE_REG(x)   ( ( ((COLUMN_INPUT_##x##_PORT == UART_TX_PORT) && (COLUMN_INPUT_##x##_PIN == UART_TX_PIN)) || \
