 ...
 * \file app_touchpad.h
 *
 * \brief This module provides an API for getting tracking and gesture events from a 
 * touchpad controller.
 *
 * Define symbol HAS_TOUCHPAD_TRACKPAD or HAS_TOUCHPAD_SLIDER to include this module 
 * in the application.
 *
