...
******************************************************************************************/
struct aes_env_tag aes_env      __attribute__((section("retention_mem_area0"))); //@RETENTION MEMORY
void (*aes_cb)(uint8_t status)  __attribute__((section("retention_mem_area0"))); //@RETENTION MEMORY
