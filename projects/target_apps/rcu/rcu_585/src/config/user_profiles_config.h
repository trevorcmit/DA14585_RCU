 ...
 * \{
 * \addtogroup PROFILES_CFG
 *
 * \brief BLE profiles configuration
 *
...
/*****************************************************************************************
 * SUOTAR application profile configuration
******************************************************************************************/

// Select SPI Flash or I2C EEPROM
...
// get the RCU version from user_config_sw_ver.h
