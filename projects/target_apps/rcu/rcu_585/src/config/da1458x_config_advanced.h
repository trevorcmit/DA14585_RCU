...
/**
 ******************************************************************************
 * \brief Set the maximum number of BLE profiles
 ******************************************************************************
 */
#define CFG_NB_PRF   5
...
/****************************************************************************************************************/
/* Periodic wakeup period to poll GTL interface. Time in msec.                                                  */
/****************************************************************************************************************/
...
/* Custom heap sizes                                                                                            */
/****************************************************************************************************************/
#define DB_HEAP_SZ              2560
//#define ENV_HEAP_SZ             328
#define MSG_HEAP_SZ             3072
#define NON_RET_HEAP_SZ         256
...
/****************************************************************************************************************/
#define CFG_NVDS_TAG_BD_ADDRESS              {0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE}
...
/* Range: 27 - 251                                                                                              */
/****************************************************************************************************************/
#define CFG_MAX_TX_PACKET_LENGTH 137

/****************************************************************************************************************/
/* Maximum supported RX data packet length.                                                                     */
/* Range: 27 - 251                                                                                              */
/****************************************************************************************************************/
#define CFG_MAX_RX_PACKET_LENGTH 107

/****************************************************************************************************************/
/* Number of TX buffers. If not defined it is set to 5 for one connection or 3*CFG_MAX_CONNECTIONS              */
/****************************************************************************************************************/
#define CFG_NUM_OF_BLE_TX_BUFFERS 18
