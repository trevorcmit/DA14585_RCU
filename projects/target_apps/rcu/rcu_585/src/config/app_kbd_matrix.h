...
static const uint16_t kbd_keymap[KBD_NR_SETS][KBD_NR_ROW_OUTPUTS][KBD_NR_COLUMN_INPUTS] =
{
  ...
  /* No Fn key pressed 
      ...
      AUDIO      0         Fn (motion)   
      -------------------------------------*/
    { 0x001E,    0x001F,   0x0020,          }, // 0
    { 0x0021,    0x0022,   0x0023,          }, // 1
    { 0x0024,    0x0025,   0x0026,          }, // 2
    { AUDIO_KEY, 0x0027,   MOTION_LOCK_KEY, }, // 3
  },
  {
   /* Fn key pressed
      0              1           2      
      --------------------------------------
      L-Click        Up arrow    Back       
      Left arrow     Enter       Right arrow
      VOL-           Down arrow  VOL+       
      AUDIO          Tab         Fn (motion)   
      --------------------------------------*/
    { MOTION_CLICK,  0x0052,     BACK_KEY,        },  // 0
    { 0x0050,        0x0028,     0x004F,          },  // 1
    { VOL_MINUS_KEY, 0x0051,     VOL_PLUS_KEY,    },  // 2
    { AUDIO_KEY,     0x002B,     MOTION_LOCK_KEY, },  // 3
  }
};
